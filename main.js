...
let stateChoiceArrays = {
    ...
    "sav-weapon": weapons,
    "sav-armor": armors,
    "sav-plotvalue-ch1": plotValues[0],
    "sav-plotvalue": plotValues[1],
    "sav-location": rooms[1],
    "ini-location": rooms[1],
    "allowed-locations": roomSelectOptions,
    "allowed-locations-2": roomSelectOptions, // ??? why is this here this should be refactored
...
// TODO a deltarune-y version of this scare (or just cut it w/e)
...
// TODO purge ini code it's not important (right?)
