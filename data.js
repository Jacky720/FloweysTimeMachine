...
let flags = {
    ...
    294: ["dog_shrine_level", "The current dognation level of the Dog Shrine (0-15)."],
    295: ["shrine_text_progression", "Prevents the Dog Shrine from repeating its description after certain upgrades. (0-6)"],
